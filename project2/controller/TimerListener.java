...
public class TimerListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        processEventQueue();
        processCollision();
        gameBoard.getWindow().setTitle("Score: " + gameBoard.getScore());
    ...
    private void update() {
        ArrayList<GameElement> elements = gameBoard.getCanvas().getGameElements(); 
        for (int x = 0; x < elements.size(); x++) elements.get(x).animate();
        if (gameOver) {
